<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckPointOwnerC.aspx.cs" Inherits="DNAWebServices.FrontWeb.CheckPointOwnerC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     <hgroup class="title">
        <%--<h1><%: Title %></h1>--%>
        <h2>ตรวจสอบคะแนนผู้รับเหมา /โครงการ</h2>
    ...
    <fieldset>
        <legend>คะแนนผู้รับเหมา /โครงการ</legend>
        <div style="width:100%;">
            ...
            <div style="float:left; width:90%">
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    <tr>
                        <td>                            
                            <asp:Label ID="Label1" runat="server" CssClass="lbtxt">กรุณาเลือกช่วงเวลาในการตรวจสอบข้อมูล คะแนนสะสม ของผู้รับเหมา /โครงการ </asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="lbtxt">หรือ ระบุชื่อผู้รับเหมา /โครงการ ที่ท่านต้องการค้นหา</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div style="width:100%">
                                    <div style="float:left; text-align:right; width:60%">
                                        <asp:Label ID="Label3" runat="server" CssClass="lbtxt">ชื่อผู้รับเหมา /โครงการ  หรือ รหัส</asp:Label>&nbsp;&nbsp;
        ...
        <div style="width:100%;">
            ...
            <div style="float:left; width:90%">
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    <tr>
                        <td>                            
                            <asp:Label ID="Label6" runat="server" CssClass="lbtxt">คะแนนสะสม ผู้รับเหมา /โครงการ xxxxxx รหัส xxxxx</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
