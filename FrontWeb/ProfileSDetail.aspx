<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="ProfileCDetail.aspx.cs" Inherits="DNAWebServices.FrontWeb.ProfileSDetail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     <hgroup class="title">
        <%--<h1><%: Title %></h1>--%>
        <h2>ข้อมูล Sub Agent 1</h2>            
    </hgroup>
    <div style="text-align:center">
<fieldset>
    <legend>ข้อมูลร้านค้าย่อย</legend>
        ...
        <br />        
        <div style="text-align:center">            
            <asp:Button ID="btnconf" CssClass="btnGray" runat="server" Text="ย้อนกลับ" OnClick="btnconf_Click" />&nbsp;&nbsp;
