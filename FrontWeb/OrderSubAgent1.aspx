<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderSubAgent1.aspx.cs" 
    Inherits="DNAWebServices.FrontWeb.OrderSubAgent1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <h1>รายการขายสินค้าร้านค้าย่อย</h1>
            ...
            <fieldset>
                        <legend>รายการขายสินค้าร้านค้าย่อย</legend>
              ...
              <asp:TextBox runat="server" ID="TextBox2"   />
                             ...
                             <li>
                                <asp:Label ID="Label6" runat="server" AssociatedControlID="UserName">  ชื่อร้านค้าช่วง</asp:Label>
