<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegisterC.aspx.cs" Inherits="DNAWebServices.FrontWeb.RegisterC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <hgroup class="title">
        <%--<h1><%: Title %></h1>--%>
        <h2>สมัครสมาชิกโครงการ ดีเอ็นเอ สำหรับผู้รับเหมา/โครงการ/หน่วยงาน</h2>            
    </hgroup>
    <div style="text-align:center">
    <fieldset>
    <legend>ข้อมูลผู้รับเหมา/โครงการ/หน่วยงาน</legend>
            <div style="text-align:left; margin-left:35px">
                ...
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; width:300px ">
                            <asp:Label ID="Label4" runat="server" CssClass="lbtxt">ชื่อ *</asp:Label>                    
                        </td>
                        <td style="text-align:left; width:300px">
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:900px" colspan="3">
                            <div style="text-align:center">
                                <div style="float:left;">
                                    <asp:RadioButton ID="RadioButton1" runat="server" Width="25px"  />
                                </div>
                                <div style="float:left">
                                    <asp:Label ID="Label49" runat="server" CssClass="lbtxtR" >ไม่เคย</asp:Label>
                                </div>
                                <div style="float:left">
                                    <asp:RadioButton ID="RadioButton2" runat="server" Width="25px"  />
                                </div>
                                <div style="float:left">
        ...
        <br />
        <fieldset>
            <legend>กรุณาระบุชื่อ ร้านตัวแทนจำน่าย หรือร้านค้าย่อย ที่ท่านสั่งซื้อสินค้า
</legend>
            <div style="width:100%;">
