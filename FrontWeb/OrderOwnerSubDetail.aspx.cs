...
{
    public partial class OrderOwnerSubDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblStartDate2.Text = txtStartDate.Text;
                lblEndDate2.Text = txtEndDate.Text;
            }
        }
        ...
        {
            Response.Redirect("OrderOwnerDetail.aspx");
        }
    }
}