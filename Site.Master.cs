...
namespace DNAWebServices
{
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //lbMusername.Text = Session["FullName"].ToString();
            }
        }
        ...
        protected void lbMusername1_Click(object sender, EventArgs e)
        {
            Response.Redirect("LogOff.aspx");
        }

        protected void lbMusername0_Click(object sender, EventArgs e)
        {
        ...
        protected void lbMusername_Click(object sender, EventArgs e)
        {
            Response.Redirect("ProfileMenu.aspx");
        }
        ...
        {
            Response.Redirect("MenuReward.aspx");            
        }
    }
}